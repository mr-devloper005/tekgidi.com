...
export function EmptyState({
  ...
  return (
    <section className={cn('border border-current/10 bg-white/70 p-8 text-center shadow-[0_18px_40px_rgba(32,33,24,0.06)]', className)}>
      ...
      <Link href={actionHref} className="mt-6 inline-flex items-center gap-2 border border-current/15 px-5 py-3 text-sm font-semibold uppercase tracking-[0.14em] transition hover:bg-current hover:text-background">
        {actionLabel}
