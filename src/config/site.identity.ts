export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'tekgidi',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Tekgidi',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'tekgidi.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://tekgidi.com',
